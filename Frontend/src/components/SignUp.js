...
const SignUp = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (response.status === 201) {
      ...
      const decoded = await jwt_decode(json.authToken);
        ...
        <div className="shadow-lg pg-3 bg-white w-60 m-5">
          <div className="justify-content-center align-items-center p-5 mx-4">
            ...
            <Form.Group className="mb-3" controlId="validationCustom02">
              ...
              />
              <Form.Text hidden={!error} className="text-muted">
                We'll never share your email with anyone else.
              </Form.Text>
              <div hidden={error} className="text-danger text-center fa-bounce">
                Email should be Unique, this email already have an account!
              </div>
            </Form.Group>
